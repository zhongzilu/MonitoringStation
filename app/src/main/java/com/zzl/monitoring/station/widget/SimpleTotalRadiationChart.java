 ...
 */
public class SimpleTotalRadiationChart extends LineChart {

    private int COLOR_RED;

    public SimpleTotalRadiationChart(Context context) {
        super(context);
    }

    public SimpleTotalRadiationChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SimpleTotalRadiationChart(Context context, AttributeSet attrs, int defStyle) {
