 ...
 */
public class AirMoistureChart extends LineChart {

    private int COLOR_AZURE;
    private int LINE;

    public AirMoistureChart(Context context) {
        super(context);
    }

    public AirMoistureChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AirMoistureChart(Context context, AttributeSet attrs, int defStyle) {
